        ...
        <form action="{{ route('pembayaran.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="harga_per_jenis_cucian" name="harga_per_jenis_cucian" value="{{ old('harga_per_jenis_cucian') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" required>
